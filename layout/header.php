...
<body class="bg-[#f5f5f7] dark:bg-black text-[#1d1d1f] dark:text-[#f5f5f7] transition-colors duration-300 min-h-screen flex flex-col font-sans antialiased">
    ...
    <nav class="sticky top-0 z-50 w-full border-b border-gray-200/50 dark:border-gray-800/50
            ...
            <div class="flex justify-between items-center h-14">
                ...
                <div class="hidden md:flex space-x-1">
                    <a href="<?= $BASE_URL ?>/index.php"
                        class="px-3 py-2 rounded-md text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/10 transition-all">
                        Home
                    </a>
        ...
        <div id="mobile-menu" class="hidden md:hidden border-t border-gray-200 dark:border-gray-800 bg-white/90 dark:bg-[#1c1c1e]/90 backdrop-blur-xl">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <a href="<?= $BASE_URL ?>/index.php"
                    class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                    Home
                </a>
                <a href="<?= $BASE_URL ?>/customers/index.php"
                    class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Re-render icons after DOM load
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div class="w-full max-w-full px-6 lg:px-10 pb-12">